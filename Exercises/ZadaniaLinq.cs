...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        return new[] { "Przedmiot nie istnieje." };
    }
    ...
    {
        bool wszyscy = DaneUczelni.Prowadzacy.All(p => !string.IsNullOrWhiteSpace(p.Katedra));
    ...
    {
        return DaneUczelni.Studenci
            .SelectMany(s => DaneUczelni.Zapisy.Where(z => z.StudentId == s.Id),
                (student, zapis) => new {student, zapis})
            .SelectMany(sz => DaneUczelni.Przedmioty.Where(p => p.Id == sz.zapis.PrzedmiotId),
                (sz, przedmiot) => $"{sz.student.Imie} {sz.student.Nazwisko} - {przedmiot.Nazwa}");
    ...
    public IEnumerable<string> Zadanie13_GrupowanieZapisowWedlugPrzedmiotu()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Przedmioty,
                ...
                (grupa, przedmiot) => $"{przedmiot.Nazwa}: {grupa.Count()}");
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Przedmioty,
                grupa => grupa.Key,
                przedmiot => przedmiot.Id,
                (grupa, przedmiot) => $"{przedmiot.Nazwa}: {grupa.Average(z => z.OcenaKoncowa.Value):F2}");
    }
    ...
    public IEnumerable<string> Wyzwanie01_StudenciZWiecejNizJednymAktywnymPrzedmiotem()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Studenci, 
                grupa => grupa.Key, 
                student => student.Id, 
                (grupa, student) => $"{student.Imie} {student.Nazwisko}: {grupa.Count()}");    
    }
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Przedmioty
            ...
            .GroupJoin(DaneUczelni.Zapisy, 
                ...
                (przedmiot, zapisy) => new { Przedmiot = przedmiot, Zapisy = zapisy })
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy
            ...
            .Select(wynik => $"{wynik.Prowadzacy.Imie} {wynik.Prowadzacy.Nazwisko}: {(wynik.Oceny.Any() ? wynik.Oceny.Average().ToString("F2") : "Brak ocen")}");
    }
